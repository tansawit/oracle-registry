...
// Source: https://github.com/smartcontractkit/chainlink/edit/develop/contracts/src/v0.8/interfaces/FeedRegistryInterface.sol
...
interface IFeedRegistryInterface {
    ...
    function getFeed(address base, address quote)
        external
        view
        returns (IAggregatorV2V3Interface aggregator);

    function getPhaseFeed(
        address base,
        address quote,
        uint16 phaseId
    ) external view returns (IAggregatorV2V3Interface aggregator);
    ...
    function getProposedFeed(address base, address quote)
        external
        view
        returns (IAggregatorV2V3Interface proposedAggregator);
